...
@media(max-width:768px){
    ...
    <div class="container">
    	<div class="navbar-header">
			...
			<a class="navbar-brand" href="prof.php">Inte-Ract</a>
		</div>
		<div class="collapse navbar-collapse" id="navbar">

			<ul class="nav navbar-nav navbar-right">
				<li class="active"><a href="index.html">Main Menu<span class="sr-only">(current)</span></a></li>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="contact" type="text" name="designation" placeholder="Enter your Designation here" class="form-control input-md" required="">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="contact" type="text" name="work" placeholder="Currently Work in" class="form-control input-md" required="">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="contact" type="text" name="dept"  class="form-control input-md" required="">
  </div>
</div>
			...
			<ul id="login-dp" class="dropdown-menu">
				<li>
					 <div class="row">
							<div class="col-md-12">
								Login
								 <form class="form" role="form"  accept-charset="UTF-8" id="login-nav" method="post" action="login.php">
										<div class="form-group">
